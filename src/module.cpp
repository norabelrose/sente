...
PYBIND11_MODULE(sente, module){
    ...
    py::class_<sente::GTP::Responder>(GTP, "Responder")
            .def(py::init<std::string, std::string>(),
                    py::arg("name") = "unimplemented_engine",
                    py::arg("version") = "0.0.0")
            .def("interpret", &sente::GTP::Responder::interpret, R"pbdoc(
            ...
            .def("GenMove", [inspect, typing](sente::GTP::Responder & session, py::function& function){
            ...
            .def("Command", [inspect, typing](sente::GTP::Responder & session, py::function& function) -> py::function& {
            ...
            .def("active", [](const sente::GTP::Responder & engine){
                return engine.isActive();
            }, R"pbdoc(
                returns whether or not the GTP Responder is active

                :return active: whether or not the GTP Responder is active
            )pbdoc")
            .def_readwrite("game", &sente::GTP::Responder::masterGame)
            .def_property("name", &sente::GTP::Responder::getEngineName, &sente::GTP::Responder::setEngineName);
